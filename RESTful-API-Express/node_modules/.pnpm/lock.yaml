...
importers:
  ...
  .:
    ...
    devDependencies:
      ...
      ts-node-dev:
        specifier: ^2.0.0
        version: 2.0.0(@types/node@22.13.4)(typescript@5.7.3)
      typescript:
        specifier: ^5.7.3
        version: 5.7.3
...
packages:
  ...
  '@types/faker@6.6.11':
    resolution: {integrity: sha512-/m/YZdfPXeM3dnSBz4JDbbYXelBm+onjsX2+LZV1XPJjIOpdhoc8ngws67iyXdLJwLiigOcejBufaDdjuVWy3Q==}
...
snapshots:
  ...
  ts-node-dev@2.0.0(@types/node@22.13.4)(typescript@5.7.3):
    dependencies:
      chokidar: 3.6.0
      dynamic-dedupe: 0.3.0
      minimist: 1.2.8
